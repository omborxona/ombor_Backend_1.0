...
func main() {
	...
	config.AllowOrigins = []string{"https://subtle-squirrel-58c164.netlify.app/#/"}
	config.AllowMethods = []string{"GET", "POST", "PUT", "DELETE"}
    config.AllowAllOrigins = true
    router.Use(cors.New(config))

	router.OPTIONS("/*cors", func(c *gin.Context) {
        c.Writer.Header().Set("Access-Control-Allow-Origin", "https://subtle-squirrel-58c164.netlify.app/#/")
